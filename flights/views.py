...
from .serializers import FlightSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingSerializer, RegisterSerializer, StaffUpdateBookingSerializer
...
class UpdateBooking(RetrieveUpdateAPIView):
    ...
    def get_serializer_class(self):
        if self.request.user.is_staff:
            return StaffUpdateBookingSerializer
...
class BookFlight(CreateAPIView):
    serializer_class = StaffUpdateBookingSerializer
